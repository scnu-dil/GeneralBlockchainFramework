...
solc_default_output = "./temp"

if platsys.lower().startswith("win"):
    solc_bin = solc_bin.replace("/", "\\")


# sample: bin/solc/solc.exe --abi --bin --allow-paths=./temp temp/Test.sol -o ./tmp
...
or update the solc binary path constant in contracts/solcpy.py.''')
